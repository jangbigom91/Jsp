...
<section id="board" class="view">
    ...
    <table>
        ...
        <tr>
            <td>첨부파일</td>
            <td>
                <a href="/Farmstory1/board/proc/download.jsp?seq=<%= fBean.getSeq() %>"><%= fBean.getOldName() %></a>
    ...
    <div>
    	<% 
       	...
       	%>
        <a href="/Farmstory1/board/proc/delete.jsp?group=<%= group %>&cate=<%= cate %>&seq=<%= article.getSeq() %>" onclick="return onDelete()" class="btnDelete">삭제</a>
