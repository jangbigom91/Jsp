    ...
    <section>
        <aside>
            ...
            <ul>
                ...
                <li class="${cate=='faq' ? 'on' : ''}"><a href="/Farmstory2/board/list.do?group=community&cate=faq">고객문의</a></li>
                <li class="${cate=='qna' ? 'on' : ''}"><a href="/Farmstory2/board/list.do?group=community&cate=qna">자주묻는질문</a></li>
            </ul>
        </aside>
        <article>
            <nav>
                ...
                <p>
                    ...
                    <c:if test="${cate=='faq'}"><span>고객문의</span></c:if>
                    <c:if test="${cate=='qna'}"><span>자주묻는질문</span></c:if>
                </p>
            </nav>
            <div class="content">
            	<!-- 컨텐츠 내용 시작 -->